        ...
        with torch.no_grad():
            for _, batch in enumerate(data_loader):
                with torch.autocast("cuda"):
                    ...
                    print("prompt:",prompt)
                    print("image_garm:",image_garm.shape)
                    ...
                    with autocast_ctx:
                        ...
                        prompt = prompt + ", a photography of a model"
                        ...
                        samples = pipeline(
                            ...
                            generator=generator,
                            cross_attention_kwargs={"attn_store": attn_store, "do_classifier_free_guidance": guidance_scale > 1.0, "enable_cloth_guidance": False, "use_independent_condition": False},
                        ).images[0]
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with torch.autocast("cuda"):
                ...
                encoder_hidden_states = text_encoder(tokenize_captions(prompt).to(accelerator.device), return_dict=False)[0]
